...
OTHER_AGENTS_DEFINITIONS = {
    "extractor": {
        ...
        "task_instructions": (
            ...
            "- Existential and Societal Risks (e.g., labor transitions, environment, democracy)\n"
    ...
    "judge": {
        ...
        "task_instructions": (
            ...
            "- Existential and Societal Risks: Assesses labor impacts, environmental sustainability, and democratic protections\n"
