...
ANALYST_DEFINITIONS = {
    "product_safety": {
        ...
        "scope": (
            ...
            "'algorithm,' or 'harm' language present. Those deployer-side and user-side provisions belong in "
            "Specific Use & Sectoral Regulation, not Product Safety. "
            ...
            "5. Do not consider economic, property rights, or market structure issues."
        ),
        "task_instructions": (
    ...
    "property_rights": {
        ...
        "scope": (
            ...
            "protection where the harm is nonconsensual use of one's body) = Property Rights. Deception-based "
            "content bans (e.g., election deepfakes where the harm is voter manipulation) = Specific Use. "
    ...
    "market_structure": {
        ...
        "scope": (
            ...
            "preferences, or state purchasing rules as Market Structure. These belong in Institutional "
            "Processes & Governance. Only score this category if the regulation affects the broader "
            "private market structure, not just the state's role as a customer. "
            "2. Do NOT score ownership or property rights provisions as Market Structure. Assigning "
            ...
            "protection. Market Structure is about COMPETITIVE access to data and resources—ensuring "
            "multiple market participants can compete fairly. Privacy-focused data provisions belong "
            "in Property Rights, not Market Structure."
        ),
        "task_instructions": (
            "Based on the provided bill extracts, you must determine a relevance score for your specific dimension. "
            "First, reason through how the text relates to your specific scope. "
    ...
    "specific_use": {
        ...
        "scope": (
            ...
            "it is Specific Use regardless of whether that exact sector appears in the examples. "
            "2. When another dimension's provisions appear as requirements on DEPLOYERS (insurers must audit, "
            "platforms must ensure safety, agencies must have oversight), those are Specific Use provisions "
            "because they regulate USE of AI in that sector. "
            ...
            "regulating AI in healthcare—it is creating a governance body (Institutional Processes). "
            "A bill that says 'appropriate $7.5M for AI wildfire tools' is NOT regulating AI use—it is "
            "funding AI development (Funding & Economic Development). "
    ...
    "societal_impact": {
        ...
        "scope": (
            ...
            "or national security strategy, you must score it as 0. "
            "This includes, but is not limited to: "
            ...
            "content about candidates are SPECIFIC USE, not Societal Impact. 'Democratic Process' means "
            "protecting election INFRASTRUCTURE and ADMINISTRATION (voting systems, ballot counting, "
            "election official tools)—NOT regulating election CONTENT (what can be published about candidates). "
            ...
            "societal impact without imposing actual requirements. Study mandates belong in Institutional "
            "Processes. Only score bills that impose actual REQUIREMENTS on AI systems or their operators "
            "regarding environmental footprint, labor impact, etc."
        ),
        "task_instructions": (
            "Based on the provided bill extracts, you must determine a relevance score for your specific dimension. "
            "First, reason through how the text relates to your specific scope. "
    ...
    "institutional_processes": {
        ...
        "scope": (
            ...
            "**SCORE 1 WHEN:** The bill's PRIMARY purpose is creating named governance bodies (task forces, "
            "councils, commissions, boards), establishing formal study requirements with legislative reporting, "
            "granting new agency jurisdiction over AI, or creating regulatory sandboxes."
        ),
        "task_instructions": (
            "Based on the provided bill extracts, you must determine a relevance score for your specific dimension. "
            "First, answer the THRESHOLD QUESTION: Does this bill create governance bodies, study "
            "mandates, or regulatory frameworks SPECIFICALLY for artificial intelligence, machine "
            "learning, or automated systems? If the bill creates general technology committees, "
            "education advisory bodies, or policy frameworks that do not specifically target AI, "
            "score 0 immediately. If YES, proceed to analyze the provisions. "
            "Then, using the provided scoring rubric, assign an overall score from the following values only: 0, 0.5, or 1. "
            "Finally, provide a brief but clear justification for your score, citing "
            "specific elements from the text. Your output must be a valid JSON object with the following fields:\n"
            "- score: A number that must be exactly 0, 0.5, or 1\n"
        ...
        "revision_instructions": (
            ...
            "Re-evaluate the bill extracts in light of this feedback and provide an updated response. "
            "Your new response must still follow all original instructions: "
            "First, re-answer the THRESHOLD QUESTION: Does this bill create AI-specific governance "
            "bodies or frameworks? If the bill addresses general technology or non-AI topics, score 0. "
            "Then, using the provided scoring rubric, assign an updated score that addresses the judge's feedback. The score must be exactly 0, 0.5, or 1. "
            "Finally, provide a brief but clear justification for your new score, citing specific elements from the text. "
            "Your output must be a valid JSON object with the following fields:\n"
            "- score: A number that must be exactly 0, 0.5, or 1\n"
