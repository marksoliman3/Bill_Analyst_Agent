...
ANALYST_DEFINITIONS = {
    ...
    "institutional_processes": {
        ...
        "scope": (
            ...
            "5. Do NOT score bills whose PRIMARY purpose is imposing substantive rules on how AI "
            "is used (e.g., banning certain AI applications, requiring disclosures in a sector, "
            "mandating bias audits by deployers) merely because the bill ALSO includes standard "
            "enforcement mechanisms, rulemaking authority, or reporting requirements. Most substantive "
            "legislation includes implementation provisions—that does not make it 'governance.' "
            "Only score when the bill's CENTRAL PURPOSE is creating oversight infrastructure: named "
            "bodies, formal study mandates with legislative reporting, new jurisdictional authority, "
            "or regulatory sandboxes. If the governance provisions are incidental to substantive "
            "rules, score 0. "
            "6. Do not analyze specific technical standards or content policies outside the scope of "
